...
function ensureOriginIsCanonicalRepo(): void {
  ...
  const allowed = new Set([
    "git@github.com:GenixBit/NemoClaw.git",
    "https://github.com/GenixBit/NemoClaw.git",
    "https://github.com/GenixBit/NemoClaw",
  ...
  if (!allowed.has(originUrl)) {
    throw new Error(
      `origin must point to the canonical GenixBit/NemoClaw repository. Found: ${originUrl}`,
    );
  }
}
